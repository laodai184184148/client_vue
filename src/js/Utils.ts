...
export interface Config {
  ...
  API_KYC_CREATE_ENDPOINT: string;
  API_KYC_RESULT_ENDPOINT_PATTERN: string;
  API_KYC_REGISTER_FACE_ENDPOINT_PATTERN: string;
  API_KYC_IDENTIFY_ENDPOINT_PATTERN: string;
  IMAGE_WIDTH: string;
  IMAGE_HEIGHT: string;
...
export class Utils {
  ...
  static convertToCamel(str: string): string {
